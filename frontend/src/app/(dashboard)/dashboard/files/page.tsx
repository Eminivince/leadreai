    ...
    >
     ...
     <div>
      ...
      <textarea
       ...
       maxLength={1000}
       className="w-full bg-[color:var(--paper)] border border-[color:var(--rule)] hover:border-[color:var(--ink-3)] focus:border-[color:var(--forest)]/60 focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--forest)_8%,transparent)] rounded-md px-3 py-2 outline-none text-[13.5px] leading-[1.55] text-[color:var(--ink)] placeholder:text-[color:var(--ink-3)] resize-none transition-colors"
      />
     </div>
 ...
 return (
  <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-10 py-8 md:py-10 animate-fade-up">
   ...
   <div className="flex items-center justify-between gap-3 flex-wrap mb-4">
    ...
    <div className="flex items-center gap-2 h-8 px-3 border border-[color:var(--rule)] bg-[color:var(--paper)] hover:border-[color:var(--ink-3)] focus-within:border-[color:var(--forest)]/60 focus-within:shadow-[0_0_0_3px_color-mix(in_srgb,var(--forest)_8%,transparent)] rounded-md w-[260px] md:w-[280px] transition-colors">
