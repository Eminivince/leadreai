    ...
    <div className="max-w-[1480px] mx-auto px-6 md:px-8 lg:px-10 py-10 md:py-14">
      ...
      {!isLoading && tables.length === 0 && (
        <div className="border border-dashed border-[color:var(--rule)] bg-[color:var(--paper-3)]/50 rounded-sm p-10 text-center">
          ...
          <button
            onClick={() => setDialogOpen(true)}
            className="mt-5 inline-flex items-center gap-2 bg-[color:var(--ink)] text-[color:var(--paper)] px-4 py-2.5 rounded-full font-[family-name:var(--font-barlow)] text-[13px] font-medium hover:bg-[color:var(--forest)] transition-colors"
          >
            New table +
          </button>
        </div>
          ...
          {tables.map((t) => (
            ...
            >
              <div className="min-w-0">
                <h3 className="font-[family-name:var(--font-instrument-serif)] text-[20px] leading-tight text-[color:var(--ink)]">
                  {t.name}
                </h3>
                {t.description && (
                  <p className="mt-0.5 font-[family-name:var(--font-barlow)] text-[13px] text-[color:var(--ink-2)] line-clamp-1">
                    {t.description}
                  </p>
                )}
              </div>
              ...
              <span className="font-[family-name:var(--font-jetbrains-mono)] text-[10px] tracking-[0.18em] uppercase text-[color:var(--ink-3)] min-w-[100px] text-right">
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
      ...
      <div className="relative w-[min(92vw,560px)] bg-[color:var(--paper)] border border-[color:var(--rule)] rounded-sm">
        <div className="p-8 md:p-10">
          ...
          <h2 className="font-[family-name:var(--font-instrument-serif)] text-[36px] leading-[1.05] text-[color:var(--ink)] mb-6">
