    ...
    <GlassCard className="p-5">
      ...
      <div className="flex flex-col gap-2">
        {items.map((s, i) => {
          ...
          const cls = 'group relative text-left rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] transition px-4 py-3 flex items-center gap-3 overflow-hidden';
          return s.onClick ? (
