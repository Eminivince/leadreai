    ...
    return (
      <div className="flex flex-col gap-5">
        <div className="border border-dashed border-[color:var(--rule)] bg-[color:var(--paper-2)] rounded-sm p-6">
          ...
          <h3 className="mt-2 font-[family-name:var(--font-instrument-serif)] text-[24px] leading-[1.15] text-[color:var(--ink)]">
        ...
        <div>
          ...
          <ul className="mt-3 border-t border-[color:var(--rule)]">
            {[
              ...
              <li
                key={s}
                className="flex items-baseline gap-3 py-2.5 border-b border-[color:var(--rule)]/70 font-[family-name:var(--font-barlow)] text-[13px] text-[color:var(--ink-2)]"
              >
                <span className="font-[family-name:var(--font-jetbrains-mono)] text-[10px] tracking-[0.2em] text-[color:var(--ink-3)]">
                  ·
                </span>
                {s}
              </li>
  ...
  return (
    <div className="flex flex-col gap-7">
      ...
      <div>
        ...
        <h3 className="mt-2 font-[family-name:var(--font-instrument-serif)] text-[24px] leading-[1.15] text-[color:var(--ink)]">
          Connected to portal{' '}
          <span className="font-[family-name:var(--font-jetbrains-mono)] text-[18px] text-[color:var(--forest)]">
            {status.portalId}
          </span>
        </h3>
      </div>
            ...
            <div
              className={`mt-1 text-[color:var(--ink)] ${
                m.mono
                  ...
                  : 'font-[family-name:var(--font-barlow)] text-[14px]'
              }`}
            >
              {m.value}
            </div>
      ...
      <div>
        ...
        <div className="mt-3 border-t border-[color:var(--rule)]">
          {syncLog === undefined ? (
            <div className="py-6 text-center font-[family-name:var(--font-barlow)] italic text-[13px] text-[color:var(--ink-3)]">
              Loading ledger…
            </div>
          ) : syncLog.length === 0 ? (
            <div className="py-6 text-center font-[family-name:var(--font-barlow)] italic text-[13px] text-[color:var(--ink-3)]">
            ...
            <>
              <div className="grid grid-cols-[1fr_60px_50px_50px_40px] gap-3 py-2 font-[family-name:var(--font-jetbrains-mono)] text-[9px] tracking-[0.18em] uppercase text-[color:var(--ink-3)] border-b border-[color:var(--rule)]">
                <span>When</span>
                <span>Dir.</span>
              ...
              {syncLog.slice(0, 8).map((entry) => (
                ...
                >
                  ...
                  <span className="font-[family-name:var(--font-barlow)] italic text-[12px] text-[color:var(--ink-2)] capitalize">
                    {entry.direction}
                  </span>
                  <span className="font-[family-name:var(--font-jetbrains-mono)] text-[12px] tabular-nums text-[color:var(--ink)] text-right">
                  ...
                  <span
                    className={`font-[family-name:var(--font-jetbrains-mono)] text-[12px] tabular-nums text-right ${
      ...
      <div className="pt-6 border-t border-[color:var(--rule)] flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="group inline-flex items-center gap-2 bg-[color:var(--ink)] text-[color:var(--paper)] px-4 py-2.5 rounded-full font-[family-name:var(--font-barlow)] text-[13px] font-medium hover:bg-[color:var(--forest)] transition-colors disabled:opacity-60"
        >
