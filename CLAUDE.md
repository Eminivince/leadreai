...
## Project Management
For every new task, switch to a new git branch. when done with the task Merge back to the staging branch. Never merge to or touch main/master except told to do so.
